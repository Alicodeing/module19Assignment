        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <div class="card borde-0 shadow-lg mg-4">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update', $product->id)}}" method="put">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{old('product_id', $product->product_id)}}" type="text" class=" @error('product_id') is-invalid @enderror form-control form-control-lg" placeholder="id" name="product_id">
                                @error('product_id')
                                    <p class="invalid-feedback">{{ $message}}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($product->image != "")
                                    <img width="w-50 my-3" src="{{asset('uploads/products/'. $product->image)}}">
                                @endif
                            </div>
                            <div class="d-grid">
